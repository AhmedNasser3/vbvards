            ...
            <div class="row align-items-center">
                <div class="col-xl-3">
                    ...
                    <div class="breadcrumb">
                        <a href="index.html" rel="nofollow"><i class="mr-5 fi-rs-رئيسية"></i>رئيسية</a>
                        <span></span>
                    </div>
                </div>
...
<p>وجدنا <strong class="text-brand">{{ count($products) }}</strong> منتجات لك  for you!</p>
                </div>
...
@endforeach
            ...
            <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                <h5 class="text-white section-title style-1 mb-30" >المنتجات الجديدة</h5>
