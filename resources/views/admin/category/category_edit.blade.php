...
<div dir="rtl" style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px;" data-aos="fade-down">
    ...
    <div class="breadcrumb" style="font-size: 16px; color: #666;">الفئات / تعديل الفئة</div>
</div>

<form class="fancyModernForm_ahmad2025" action="{{ route('update.category', $category->id) }}" method="POST" enctype="multipart/form-data" data-aos="fade-up">
    @csrf
    @method('POST')
    ...
    <div class="form_group animate__animated animate__fadeInUp">
        ...
        <input type="text" id="category_name" name="category_name" maxlength="50" placeholder="اكتب اسم الفئة" value="{{ $category->category_name }}" required />
    </div>
    ...
    <div class="form_group" data-aos="zoom-in">
        ...
        <div id="uploadContainer">
            ...
            <input type="file" id="category_image" name="category_image" class="form-control" style="display: none;" />
    ...
    <div class="form_group" data-aos="zoom-in-up">
        ...
        <img id="showImage" src="{{ asset($category->category_image) }}" alt="صورة المعاينة" style="width: 100px; height: 100px;" />
    </div>
    ...
    <div class="form_group">
        <button type="submit" id="submitBtn">
            <span class="loader" id="loader"></span> <span id="submitText">حفظ التعديلات</span>
        </button>
    </div>
</form>
