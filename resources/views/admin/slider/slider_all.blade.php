                ...
                <a href="">
                    <div class="p-3 mb-2 border rounded d-flex row align-items-center justify-content-between order-item">
                        <div class="order d-flex align-items-center col-md-8">
                            <input type="checkbox" class="checkbox me-2">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('storage/' . $item->slider_image) }}" style="width: 70px; height:40px;">

                                <div>
                                    <div class="fw-bold"><h4 style="font-weight: 900; color:#00796b;">{{ $item->slider_title }}</h4></div>
                                    <div class="fw-bold">{{ $item->short_title }}</div>
                        ...
                        <div class="justify-center action_buttons d-flex flex-column text-start col-md-4">
                                ...
                                <button>
                                    <a href="{{ route('edit.slider',$item->id) }}" class="btn btn-info">تعديل</a>
                                </button>
                                <button>
                                    <a href="{{ route('delete.slider',$item->id) }}" class="btn btn-danger" id="delete">ازالة</a>
                                </button>
                            </div>
                        </div>
                    </div>
