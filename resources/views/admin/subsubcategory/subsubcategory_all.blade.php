                ...
                <a href="">
                    <div class="p-3 mb-2 border rounded d-flex row align-items-center justify-content-between order-item">
                        <div class="order d-flex align-items-center col-md-8">
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <div class="fw-bold"><h4 style="font-weight: 900; color:#00796b;">{{ $item->subsubcategory_name }}</h4></div>
                                    <div class="fw-bold">{{ $item->subcategory->subcategory_name ?? 'تم مسح القسم الفرعي' }}</div>
                                    <div class="fw-bold">{{ $item->category->category_name }}</div>
