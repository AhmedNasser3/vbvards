...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('store.state') }}"   >
	 	...
	 	<select name="division_id" class="mb-3 form-select" aria-label="Default select example">
			...
			<div class="mb-3 row">
				...
				<div class="form-group col-sm-9 text-secondary">
	 	<select name="district_id" class="mb-3 form-select" aria-label="Default select example">
