...
<div dir="rtl" style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px;" data-aos="fade-down">
    ...
    <div class="breadcrumb" style="font-size: 16px; color: #666;">العلامات التجارية / الرئيسية</div>
</div>

<form class="fancyModernForm_ahmad2025" method="post" action="{{ route('store.brand') }}" enctype="multipart/form-data" data-aos="fade-up">
    @csrf

    <div class="form_group animate__animated animate__fadeInUp">
        <label for="brand_name">اسم العلامة التجارية <span id="charCount">0</span>/50</label>
        <input type="text" id="brand_name" name="brand_name" maxlength="50" placeholder="اكتب اسم العلامة" required />
    </div>
    ...
    <div class="form_group" data-aos="zoom-in">
        ...
        <div id="uploadContainer">
            ...
            <input type="file" id="brand_image" name="brand_image" class="form-control" style="display: none;" required />
    ...
    <div class="form_group" data-aos="zoom-in-up">
        ...
        <img id="showImage" src="{{ isset($brand->brand_image) ? asset('upload/brands/'.$brand->brand_image) : url('upload/no_image.jpg') }}" alt="صورة المعاينة" style="width: 100px; height: 100px;" />
    </div>
